...
- **Nästa:** självhosta WASM (D-2 a) + SW-precache; enhetstest på fas-logiken; utvärdera pose-impact mot manuell etikett på 20 klipp (D-3). Detaljer i [pose-detection.md](pose-detection.md).
